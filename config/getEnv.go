...
func Load() Config {
  ...
  config.HTTPPortAuth = cast.ToString(getOrReturnDefaultValue("HTTP_PORT_AUTH", ":8081"))
  config.HTTPPortForum = cast.ToString(getOrReturnDefaultValue("HTTP_PORT_FORUM", ":8082"))
